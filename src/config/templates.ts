...
export const profileTemplates: Record<ProfileType, TemplateConfig> = {
  estudiante: {
    ...
    sidebarItems: [
      { id: "home",     label: "Mi Vida",       href: "/dashboard", icon: Home },
      { id: "planning", label: "Planear Hoy",   href: "/planning",  icon: CalendarDays },
      { id: "plans",    label: "Mis Metas",     href: "/plans",     icon: Target },
      { id: "chat",     label: "IA Mentor",     href: "/chat",      icon: MessageSquare },
      { id: "study",    label: "Aprender",      href: "/study",     icon: Zap },
      { id: "notes",    label: "Notas",         href: "/notes",     icon: Brain },
      { id: "library",  label: "Conocimiento",  href: "/library",   icon: BookOpen },
