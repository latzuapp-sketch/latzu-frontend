...
const translations = {
  en: {
    ...
    hero: {
      ...
      ctaPrimary: "Start free — 7 days",
      ctaSecondary: "How it works",
      socialProof: "No credit card required · Cancel anytime",
      onlineStatus: "Online",
      chatMessage1:
    ...
    finalCtaSection: {
      ...
      title2: "starts today",
      subtitle:
        "Join the new generation of students who learn with adaptive intelligence. 7 days free, no commitments.",
      ctaPrimary: "Start now — it's free",
      ctaSecondary: "Log in",
      socialProof: "No credit card · Cancel anytime · HTTPS encrypted",
    },
    ...
    login: {
      ...
      cardTitle: "Welcome",
      cardDescription: "Log in or create a new account",
      ...
      orDivider: "or",
      guestButton: "Try without signing up",
      guestInfo1: "Trial mode lets you explore all features.",
      guestInfo2: "Sign up to save your progress permanently.",
      features: [
    ...
    register: {
      ...
      cardTitle: "Sign up",
      cardDescription: "Create an account to save your progress",
      nameLabel: "Name",
  ...
  es: {
    ...
    hero: {
      ...
      ctaPrimary: "Empezar gratis — 7 días",
      ctaSecondary: "Cómo funciona",
      socialProof: "Sin tarjeta de crédito · Cancela cuando quieras",
    ...
    finalCtaSection: {
      ...
      title2: "empieza hoy",
      subtitle:
        "Únete a la nueva generación de estudiantes que aprenden con inteligencia adaptativa. 7 días gratis, sin compromisos.",
      ctaPrimary: "Empezar ahora — es gratis",
      ctaSecondary: "Iniciar sesión",
      socialProof: "Sin tarjeta de crédito · Cancela cuando quieras · HTTPS cifrado",
    },
    ...
    login: {
      ...
      cardDescription: "Inicia sesión o crea una cuenta nueva",
      ...
      orDivider: "o",
      guestButton: "Probar sin registrarse",
      guestInfo1: "El modo de prueba te permite explorar todas las funciones.",
      guestInfo2: "Regístrate para guardar tu progreso permanentemente.",
      features: [
    ...
    register: {
      ...
      cardDescription: "Crea una cuenta para guardar tu progreso",
      nameLabel: "Nombre",
